'''
This file is adapted from `fetch.py` from 
https://github.com/theopolisme/fast-courses 
'''
...
COURSE_ENDPOINT = (ENDPOINT + 'search?view=xml-20140630&academicYear='
                   ...
                   # Uncomment the line for the current quarter
                   # '&filter-coursestatus-Active=on&filter-term-Autumn=on')
                   # '&filter-coursestatus-Active=on&filter-term-Winter=on')
                   '&filter-coursestatus-Active=on&filter-term-Spring=on')
